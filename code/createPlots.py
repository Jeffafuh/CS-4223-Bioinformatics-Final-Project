...
def plot_nSeqs():
    """
    Plots the nSeqs runtime files for both algorithms in linear and log-y scale.
...
def plot_seqL():
    """
    Plots the seqL runtime files for both algorithms in linear and log-y scale.
...
def plot_motifL():
    """
    Plots the motifL runtime files for both algorithms in linear and log-y scale.
...
def plot_nMuts():
    """
    Plots the nMuts runtime files for both algorithms in linear and log-y scale.
